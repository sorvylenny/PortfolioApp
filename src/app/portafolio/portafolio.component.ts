...
export class PortafolioComponent {
  ...
  list_Experiencias: Portfolio[] = [
    { description: 'Freelancer', description2: 'Febrero 2024 - Agosto 2024', description3: ' De febrero a marzo estuve colaborando al proyecto en ionic Angular, que es de una brigada de socorristas en medellín. De marzo a abril, trabajé en un proyecto no code con Apphive, se trataba de una app de mascotas, fue entregado el MVP. De junio a agosto, participé en un proyecto inmobiliario de venta de propiedades, integrando mapas con Leaflet en Angular 18, integraciones al backend con Php(Laravel), el cual se entregó el MVP.Posteriormente, continué colaborando en otro proyecto llamado Mercado Meet, desarrollado en Angular 17 con backend en nest.js.' },
  ...
  list_Proyectos2: Portfolio[] = [
    { videoUrl: 'https://lottie.host/embed/8b865b26-9c69-4ac5-8ffd-650e4d284fb1/StBrubj6kC.json', description: 'System Sales Api', description2: 'System Sales Este proyecto es una API que proporciona unas funcionalidades para gestionar el sistema de facturación de ventas de repuestos de automóviles y motos. Ver mas información esta en el Readme.', description3: 'https://github.com/sorvylenny/SystemSales', links: 'http://www.systemsales.somee.com/swagger/index.html', title: '#C, #SQL Server, #Swagger' },
